...
class CommandPaletteQt(QDialog):
    ...
    def _load_items(self):
        self._all_items = [
            ...
            ("nav", "Notepad", "🗒️ الانتقال إلى: المفكرة (Notepad)"),
            ...
            ("action", "dev_url", "🌐 أدوات المطورين: ترميز وفك ترميز الروابط (URL Tools)"),
            ...
            ("action", "dev_api", "🌐 أدوات المطورين: مختبر واجهات برمجة التطبيقات (REST API Tester)"),
            ...
            ("action", "new_notepad", "🗒️ فتح مستند جديد في المفكرة"),
